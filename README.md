...
Windows 10/11
🚀 Getting Started with QuickConnect Studio
Launch Renesas QuickConnect Studio
Login using your MyRenesas account
...
🔨 Build & Flash Procedure
Click Build QCStudio Project
Go to:
Project → Debug → *.srec file

Connect board using USB
Open SEGGER J-Flash Lite
Select device and flash the .srec file
Reset board and observe output
...
IoT and Edge AI applications# Renesas_projects
